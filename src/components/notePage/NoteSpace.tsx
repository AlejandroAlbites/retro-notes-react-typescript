    ...
    return (
        <div className='note-space-container'>
            ...
            <div className='btn-note-options'>
                <button type="button" className="nes-btn is-success" onClick={handleClick}>Editar</button>
                <button type="button" className="nes-btn is-error" onClick={handleOpenModal}>Eliminar</button>
                {isOpenModal && <ModalDeleteNote text={"¿Seguro que quieres eliminar esta nota?"} setIsOpenModal={setIsOpenModal} />}
